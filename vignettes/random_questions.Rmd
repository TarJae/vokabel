...
Creating a dynamic quiz can make it more engaging and challenging for users. The `create_question_random()` function in `vokabel` allows you to generate random questions. This vignette will guide you through how to use this function effectively.
