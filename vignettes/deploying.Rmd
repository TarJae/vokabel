...
This vignette will walk you through how to deploy your quiz created with vokabel to shinyapps.io. We'll start by creating a simple quiz, and then we'll go through the steps to deploy it online.

## Creating a Quiz
First, let's create a quiz using vokabel. Here's an example:
...
ui <- shiny::fluidPage(
  htmltools::div(
    ...
    vokabel::quiz_ui(quiz)
  )
)

# Build the server
server <- function(input, output, session) {
  vokabel::quiz_server(quiz)
}
